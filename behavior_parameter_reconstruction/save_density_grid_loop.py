...
#Loops over a set of inputted behavioral parameters (one density grid saved
#for each parameter set)

#11.6.2018: for now, using the 10/26 plume data + contructing repeats of
#two wind_slippage values: (0,0) and (0,1)
...
iterations_of_each = 5
wind_slippages = [(0,0) for i in range(iterations_of_each)]+[(0,1) for i in range(iterations_of_each)]

for wind_slippage in wind_slippages:
    ...
    #Setup fly swarm
    # wind_slippage = (0.,0.) #loop through these values
    swarm_size=1000
